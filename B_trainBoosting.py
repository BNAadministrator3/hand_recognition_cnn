...
model.fit_generator(train_generator, steps_per_epoch=20, epochs=epochs,  callbacks=[history])
...
# model.save('h5files/conv6_gap_dataaug_150epoches.h5')
# model.save_weights('h5files/conv6_gap_dataaug_150epoches_weigths.h5')
