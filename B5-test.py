...
class CNNmodels():
    ...
    def baselineCNN(self,input_shape):
        ...
        return model
    def mnistmodel(self,input_shape):
...
X_train_orig, Y_train_orig, X_test_orig, Y_test_orig, classes = loadup_dataset(training_filename='bmp/32/h5/trainingdata.h5',test_filename='bmp/32/h5/testdata.h5')
...
model.fit_generator(train_generator, steps_per_epoch=train_generator.n//batch_size+1, epochs=epochs,  callbacks=[history])
